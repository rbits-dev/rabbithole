...
const TinderCard = React.forwardRef(
  (
    { flickOnSwipe = true,onRelease, children, onSwipe, onCardLeftScreen, className, preventSwipe = [], swipeRequirementType = 'velocity', swipeThreshold = settings.swipeThreshold, onSwipeRequirementFulfilled, onSwipeRequirementUnfulfilled,setSwipeDirection },
    ref
  ) => {
    ...
    React.useLayoutEffect(() => {
      ...
      element.current.addEventListener(('touchstart'), onTouchStart,{passive:true})
      ...
      element.current.addEventListener(('mousedown'), onMouseDown,{passive:true})
      ...
      element.current.addEventListener(('touchmove'), onTouchMove,{passive:true})
      ...
      element.current.addEventListener(('touchend'), onTouchEnd,{passive:true})
